...
if(amysBirthYear === brittanisBirthYear){
  console.log(`Amy and Brittanni share the same birth year.`)
} else {
  console.log(`Amy and Brittanni do not share the same birth year.`)
}
...
if (rain === true) {
  console.log(`You might also want an umbrella. It's gonna rain.`)
} else {
